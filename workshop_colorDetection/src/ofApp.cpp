...
void ofApp::draw(){
    ...
    //in plaats van ofGetHeight te nemen, altijd gewoon de ratio gebruiken zodat als we de OF-frame herschalen dat we nog steeds juist mappen op ons videobeeld.
...
void ofApp::mouseReleased(int x, int y, int button){
    ...
    //in plaats van ofGetHeight te nemen voor y, altijd gewoon de ratio gebruiken zodat als we de OF-frame herschalen dat we nog steeds juist mappen op ons videobeeld.
